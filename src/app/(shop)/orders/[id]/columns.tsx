...
import { Eye, MoreHorizontal, Repeat, Trash2 } from "lucide-react";
...
export const columns: ColumnDef<OrdersTableData>[] = [
  ...
  },
  {
    ...
    id: "price",
    header: ({ column }) => {
      return <DataTableColumnHeader column={column} title="Prix total" />;
    },
    cell: ({ row }) => {
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem className="flex gap-2 items-center">
              <Repeat size={16} strokeWidth={1.25} /> Commander à nouveau
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      );
