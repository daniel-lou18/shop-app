...
-- CreateIndex
CREATE INDEX "Product_brandId_categoryId_sex_idx" ON "Product"("brandId", "categoryId", "sex");
...
-- CreateIndex
CREATE INDEX "Brand_name_sex_idx" ON "Brand"("name", "sex");

-- CreateIndex
CREATE INDEX "Category_name_sex_idx" ON "Category"("name", "sex");
